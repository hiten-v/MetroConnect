...
//           : 'bg-surface border-metro'}`}
//     >
//       {/* Header */}
//       <div className="p-4">
//         {isRecommended && (
//           <div className="text-[10px] font-bold tracking-widest text-accent uppercase mb-2.5">
//             ⭐ Recommended
//           </div>
//         )}
...
//               style={{
//                 background: `${seg.lineColor}22`,
//                 borderColor: `${seg.lineColor}70`,
//                 color: seg.lineColor,
//               }}
//             >
...
//           <Stat icon="🕐" label="Duration" value={`${route.totalTime} min`} />
//           <Stat icon="🚉" label="Stops"    value={route.totalStops} />
//           <Stat icon="🔄" label="Transfers" value={route.transfers} warn={route.transfers > 0} />
//           <Stat icon="₹"  label="Fare"     value={`₹${route.fare}`} accent />

//           <div className="ml-auto flex gap-2">
//             <button
//               onClick={() => setExpanded(e => !e)}
//               className="px-3 py-1.5 rounded-lg text-xs font-medium border border-metro text-muted hover:bg-surface2 hover:text-[#e8eaf6] transition-all duration-200"
//             >
//               {expanded ? '▲ Hide' : '▼ Details'}
//             </button>
//             <button
//               onClick={() => onSelect(route)}
//               className="px-4 py-1.5 rounded-lg text-xs font-bold bg-accent text-white hover:bg-accent-h transition-all duration-200"
//             >
//               Book →
//             </button>
//           </div>
